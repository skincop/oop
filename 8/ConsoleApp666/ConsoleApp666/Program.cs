...
namespace ConsoleApp666
{
    ...
    public interface IShow<T>
    {
        ...
        public void Show(T var1, T var2);
        public double Addd(T var1, T var2);

        public int Delete(T var1, T var2);

    }
    public class Set<T> : IShow<T>
    {

        public  void Show(T var1, T var2)
        {
            Console.WriteLine($"Первое{var1},второе {var2}");
        }
        public double Addd(T var1, T var2)
        {
        ...
        public int Delete(T var1, T var2)
        {
            int del = Convert.ToInt32(var1) - Convert.ToInt32(var2);
            return del;
        }
    ...
    public class Program
        ...
        new User() { Name = "Joe", Age = 8 },
            ...
            Set < int > hhh= new Set<int>();
            var res = hhh.Delete(27, 13);
            Console.WriteLine($"Разница {res}");
            Set < double > mc1= new Set<double>();
            var res1 = mc1.Addd(23.5, 48.3);
            Console.WriteLine($"Result1 {res1}");
            Console.ReadKey();
